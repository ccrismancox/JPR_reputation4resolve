...
deTest <- DEoptim(llik, lower, upper,
                  control=DEoptim.control(parallelType=1,
                                          ...
                                          steptol=100000))
outerit <- outerit+ 1
save(list="deTest", file="model6start_currentiteration.rdata") 
...
# save.image("model6_startvalues.rdata")  #only if regenerating starting values
